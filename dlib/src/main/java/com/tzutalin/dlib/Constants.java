...
public final class Constants {
    ...
    public static String getDLibDirectoryPath() {
        ...
        String targetPath = sdcard.getAbsolutePath() + File.separator + "A_dlib_rec";
        return targetPath;
    }
    ...
    public static String getFaceLandmarkModelPath() {
        File sdcard = Environment.getExternalStorageDirectory();
        String targetPath = getDLibDirectoryPath() + File.separator + "shape_predictor_68_face_landmarks.dat";
        return targetPath;
    }

    public static String getEngLangModelPath() {
        File sdcard = Environment.getExternalStorageDirectory();
        String targetPath = getDLibDirectoryPath() + File.separator +"tessdata"+ File.separator+ "eng.traineddata";
        return targetPath;
    }

    public static String getChiLangModelPath() {
        File sdcard = Environment.getExternalStorageDirectory();
        String targetPath = getDLibDirectoryPath() + File.separator+"tessdata" + File.separator + "chi_sim.traineddata";
        return targetPath;
    }
}
